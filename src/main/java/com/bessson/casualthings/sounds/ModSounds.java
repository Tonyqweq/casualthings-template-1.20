package com.bessson.casualthings.sounds;
...
public class ModSounds {
    ...
    public static final SoundEvent AAA_CD_CALL= registerSoundEvents("aaa_cd_call");
    ...
    public static SoundEvent registerSoundEvents(String name){
        Identifier identifier = new Identifier(CasualThings.MOD_ID,name);;
