package com.bessson.casualthings.entity.custom;

import com.bessson.casualthings.entity.ModEntities;
import com.bessson.casualthings.entity.ai.TigerAttackGoal;
...
public class TigerEntity extends AnimalEntity {
    ...
    protected void updateLimbs(float posDelta) {
        float f =this.getPose() == EntityPose.STANDING ? Math.min(posDelta * 6.0f,1.0f):0.6f;
